...
public class ConsoleSnakeGame {
    ...
    private ConsoleSnakePresenter snakePresenter;
    ...
    public void execute() throws IOException {
        ...
        this.snakePresenter = new ConsoleSnakePresenter();

        this.view.setPresenter(snakePresenter);
        this.snakePresenter.setProperties(properties);
        this.snakePresenter.setView(view);
