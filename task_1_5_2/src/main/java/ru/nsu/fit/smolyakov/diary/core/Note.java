 ...
 *
 * <p>The contract consists of filtering predicates, such as {@link #containsInHeading(String)},
...
public record Note(
    ...
    /**
     * Returns {@code true} if this {@code Note} heading containsInHeading
     ...
     * @return {@code true} if this {@code Note} heading containsInHeading
     * a specified {@code keyword}.
     */
    public boolean containsInHeading(String keyword) { // TODO maybe rename maybe not
